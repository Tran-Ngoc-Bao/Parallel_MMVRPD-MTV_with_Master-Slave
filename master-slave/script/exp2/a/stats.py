...
significant-best), all run with elite-pull off, td-crowding pool
replacement, and a fixed --elite-pool-size (same as exp2/g's po3:
200->4, 500->5). For each strategy reports:
...
averaged over instances (4 by default: 2 customer counts x 2 combos) to
