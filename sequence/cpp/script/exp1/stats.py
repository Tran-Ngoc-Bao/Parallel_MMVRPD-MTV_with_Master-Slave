...
def main():
    ...
    ap.add_argument("--sats-outputs", default="../../outputs/exp1/sats",
                     help="Dir containing run4_sats.sh output, relative to this script "
                          "(default: ../../outputs/exp1/sats)")
    ap.add_argument("--ims-outputs", default="../../outputs/exp1/ims",
                     help="Dir containing run4_ims.sh output, relative to this script "
                          "(default: ../../outputs/exp1/ims)")
    ...
    ap.add_argument("--outputs", default="../../outputs/exp1",
                     help="Root outputs dir (parent of sats/ and ims/), relative to this "
                          "script -- where summary.csv is written (default: ../../outputs/exp1)")
